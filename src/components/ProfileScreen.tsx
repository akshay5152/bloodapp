    ...
    <div className="profile-screen">
      ...
      <div className="profile-container">
        ...
        <div className="profile-details">
          <p>
            <strong>Mobile No:</strong> +91 {mobileNumber}
        ...
        <div className="contact-section">
          <div className="contact-icons">
            <a href="https://wa.me/919876543210" className="contact-icon whatsapp" target="_blank" rel="noopener noreferrer">
            ...
            <a href="tel:+919876543210" className="contact-icon call">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor">
            ...
            <a href="mailto:support@bloodapp.com" className="contact-icon email">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor">
